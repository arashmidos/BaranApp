...
public class CustomGridCategory extends BaseAdapter
{
    ...
    private List<Category> listi;


    public CustomGridCategory(Context c, List<Category> listi)
    {
        mContext = c;
        this.listi = listi;
...
//        ArrayList<String> m = new ArrayList<String>();
        final Category m = listi.get(position);
        ...
        holder.txtViewTitle.setText(m.getCattitle());
        holder.c = m;
        ...
        convertView.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                Category temp = holder2.c;
                ((MainActivity) mContext).showJobs(temp);
